...
// observer
router.post('/:userId/observer', authMiddleware, UserController.assignObserver);
router.delete('/:userId/observer', authMiddleware, UserController.removeObserver);

// verifier
router.post('/:userId/verifier', authMiddleware, UserController.assignVerifier);
router.delete('/:userId/verifier', authMiddleware, UserController.removeVerifier);
